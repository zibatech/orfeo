...
<tr><td width="20%" class='titulos2' align="left"> FECHA INICIAL <font color="red">(DD/MM/AAAA)</font> *
            </td>
	<td width="20%" class='titulos2'>
	...
	for($i = 1975; $i <= $agnoactual; $i++)
	{
		...
		elseif($i == 1975)$option="<option value=\"\"> TODOS</option>";
...
<?
        if($inder1==1)$sele1="checked";
	?>
	<tr>
	<td width="30%" class='titulos2'> <input type="checkbox" name="inder1" value=1 <?=$sele1?>>Biologicos: Hongos</option></td>
	<?
	if($inder2==1)$sele2="checked";
	?>
	<td width="30%" class='titulos2'> <input type="checkbox" name="inder2" value=1 <?=$sele2?>>Biologicos: Roedores</option></td>
	<?
	if($inder3==1)$sele3="checked";
	?>
	<td width="30%" class='titulos2'> <input type="checkbox" name="inder3" value=1 <?=$sele3?>>Biologicos: Insectos</option></td></tr>
	<?
	if($inder4==1)$sele4="checked";
	?>
	<tr>
	<td width="30%" class='titulos2'> <input type="checkbox" name="inder4" value=1 <?=$sele4?>>Decoloracion Soporte</option></td>
	<?
	if($inder5==1)$sele5="checked";
	?>
	<td width="30%" class='titulos2'> <input type="checkbox" name="inder5" value=1 <?=$sele5?>>Desgarros</option></td>
	</tr>
</table>	
</td>
...
if($ano!="" and $depe!="" and $orden!="" and $deman!="" and $numCap!="" and $folios!=""){
	$zon=strtoupper($zona);
	...
	//if($folios=="")$folios=0;
	if($mata1==1 and $mata2==1 and $mata3==1 and $mata4==1)$mata=42;
	elseif($mata1==1 and $mata2==1 and $mata3==1 and $mata5==1)$mata=43;
	elseif($mata1==1 and $mata2==1 and $mata3==1 and $mata6==1)$mata=44;
	elseif($mata1==1 and $mata2==1 and $mata4==1 and $mata5==1)$mata=45;
	elseif($mata1==1 and $mata2==1 and $mata4==1 and $mata6==1)$mata=46;
	elseif($mata1==1 and $mata2==1 and $mata5==1 and $mata6==1)$mata=47;
	elseif($mata1==1 and $mata3==1 and $mata4==1 and $mata5==1)$mata=48;
	elseif($mata1==1 and $mata3==1 and $mata4==1 and $mata6==1)$mata=49;
	elseif($mata1==1 and $mata3==1 and $mata5==1 and $mata6==1)$mata=50;
	elseif($mata1==1 and $mata4==1 and $mata5==1 and $mata6==1)$mata=51;
	elseif($mata2==1 and $mata3==1 and $mata4==1 and $mata5==1)$mata=52;
	elseif($mata2==1 and $mata3==1 and $mata4==1 and $mata6==1)$mata=53;
	elseif($mata2==1 and $mata3==1 and $mata5==1 and $mata6==1)$mata=54;
	elseif($mata3==1 and $mata4==1 and $mata5==1 and $mata6==1)$mata=55;
	elseif($mata1==1 and $mata2==1 and $mata3==1)$mata=22;
	elseif($mata1==1 and $mata2==1 and $mata4==1)$mata=23;
	elseif($mata1==1 and $mata2==1 and $mata5==1)$mata=24;
	elseif($mata1==1 and $mata2==1 and $mata6==1)$mata=25;
	elseif($mata1==1 and $mata3==1 and $mata4==1)$mata=26;
	elseif($mata1==1 and $mata3==1 and $mata5==1)$mata=27;
	elseif($mata1==1 and $mata3==1 and $mata6==1)$mata=28;
	elseif($mata1==1 and $mata4==1 and $mata5==1)$mata=29;
	elseif($mata1==1 and $mata4==1 and $mata6==1)$mata=30;
	elseif($mata1==1 and $mata5==1 and $mata6==1)$mata=31;
	elseif($mata2==1 and $mata3==1 and $mata4==1)$mata=32;
	elseif($mata2==1 and $mata3==1 and $mata5==1)$mata=33;
	elseif($mata2==1 and $mata3==1 and $mata6==1)$mata=34;
	elseif($mata2==1 and $mata4==1 and $mata5==1)$mata=35;
	elseif($mata2==1 and $mata4==1 and $mata6==1)$mata=36;
	elseif($mata2==1 and $mata5==1 and $mata6==1)$mata=37;
	elseif($mata3==1 and $mata4==1 and $mata5==1)$mata=38;
	elseif($mata3==1 and $mata4==1 and $mata6==1)$mata=39;
	elseif($mata3==1 and $mata5==1 and $mata6==1)$mata=40;
	elseif($mata6==1 and $mata4==1 and $mata5==1)$mata=41;
	...
	if($inder1==1 and $inder2==1 and $inder3==1 and $inder4==1 and $inder5==1)$inder=31;
	elseif($inder1==1 and $inder2==1 and $inder3==1 and $inder4==1)$inder=26;
	elseif($inder1==1 and $inder2==1 and $inder3==1 and $inder5==1)$inder=27;
	elseif($inder1==1 and $inder2==1 and $inder4==1 and $inder5==1)$inder=28;
	elseif($inder1==1 and $inder3==1 and $inder4==1 and $inder5==1)$inder=29;
	elseif($inder2==1 and $inder3==1 and $inder4==1 and $inder5==1)$inder=30;
	elseif($inder1==1 and $inder2==1 and $inder3==1)$inder=16;
	elseif($inder1==1 and $inder2==1 and $inder4==1)$inder=17;
	elseif($inder1==1 and $inder2==1 and $inder5==1)$inder=18;
	elseif($inder1==1 and $inder3==1 and $inder4==1)$inder=19;
	elseif($inder1==1 and $inder3==1 and $inder5==1)$inder=20;
	elseif($inder1==1 and $inder4==1 and $inder5==1)$inder=21;
	elseif($inder2==1 and $inder3==1 and $inder4==1)$inder=22;
	elseif($inder2==1 and $inder3==1 and $inder5==1)$inder=23;
	elseif($inder2==1 and $inder4==1 and $inder5==1)$inder=24;
	elseif($inder3==1 and $inder4==1 and $inder5==1)$inder=25;
	elseif($inder1==1 and $inder2==1)$inder=6;
	elseif($inder1==1 and $inder3==1)$inder=7;
	elseif($inder1==1 and $inder4==1)$inder=8;
	elseif($inder1==1 and $inder5==1)$inder=9;
	elseif($inder2==1 and $inder3==1)$inder=10;
	elseif($inder2==1 and $inder4==1)$inder=11;
	elseif($inder2==1 and $inder5==1)$inder=12;
	elseif($inder3==1 and $inder4==1)$inder=13;
	elseif($inder3==1 and $inder5==1)$inder=14;
	elseif($inder4==1 and $inder5==1)$inder=15;
	elseif($inder1==1)$inder=1;
	elseif($inder2==1)$inder=2;
	elseif($inder3==1)$inder=3;
	elseif($inder4==1)$inder=4;
	elseif($inder5==1)$inder=5;
	else $inder=0;
	...
	if($Ingresar){
		...
		include("$ruta_raiz/include/query/archivo/queryinsertar_central.php");
		//$db->conn->debug=true;
		if($tip!="")$query.= " and sgd_archivo_proc like '".$tip."'";
