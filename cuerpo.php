      ...
      <div class="row">
        ...
        <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
          ...
          <div class="jarviswidget jarviswidget-color-darken" id="wid-id-0" data-widget-editbutton="false">
            ...
            <div>
              <!-- widget content -->
              <div class="actions smart-form" style="position: absolute !important;
                                top: 109;
                                z-index: 1;
                                left: 246px;">
                <?php
...
?>
              ...
              <div class="widget-body no-padding">
                <div class="widget-body-toolbar" style="border: 1px #ccc solid;margin-bottom: 40px">
                  ...
                  <input type="date" name="fecha_inicial_aux" id="fecha_inicial_aux" autocomplete="off" format="YYYY-MM-DD" value="<?= empty($_SESSION['fecha_inicial']) ? '' : $_SESSION['fecha_inicial'] ?>">
                  <label>Fecha final</label>
                  <input type="date" name="fecha_final_aux" id="fecha_final_aux" autocomplete="off" format="YYYY-MM-DD" value="<?= empty($_SESSION['fecha_final']) ? '' : $_SESSION['fecha_final'] ?>">
