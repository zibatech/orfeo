...
?>
<form name=formEnviar action='../anulacion/solAnulacion.php?<?=session_name()."=".session_id() ?>&tpAnulacion=<?=$tpAnulacion?>&depeBuscada=<?=$depeBuscada?>&estado_sal_max=<?=$estado_sal_max?>&pagina_sig=<?=$pagina_sig?>&dep_sel=<?=$dep_sel?>&nomcarpeta=<?=$nomcarpeta?>&orderTipo=<?=$orderTipo?>&orderNo=<?=$orderNo?>' method=post>
<?php
				...
				<div>
					...
					<div class="widget-body no-padding">
                        ...
                        $radiPath              = $rs->fields["HID_RADI_PATH"];
							...
							?>
								<tr>
									<td><A onClick="funlinkArchivo(<?=$numeroRadicado?>, '..');" href='#'> <?=$numeroRadicado?></a></td>
