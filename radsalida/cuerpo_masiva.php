...
<table border=0 width='100%' align='center' >
	     ...
	     /** Instruccion que realiza la consulta de radicados segun criterios
		   ...
		   */
           include "$ruta_raiz/include/query/radsalida/queryCuerpoMasiva.php";
				 $rs=$db->query($isql);
				?> 
	    <table BORDER=0 cellspacing='5' WIDTH=100%  valign='top' align='center' class="table table-bordered" >
          <TR >
            <TD width='35%' > 
  ...
  ?> 
            ...
            <TD width='32%'  > 
              <table width="100%" border="0" cellspacing="1" cellpadding="0">
                <tr> 
                  <td width="10%"  height="20">Usuario</td>
                </tr><tr>
	 ...
	 <form name='form1' action='<?=$pagina_sig?>?<?="fechah=$fechah&dep_sel=$dep_sel&estado_sal=$estado_sal&estado_sal_max=$estado_sal_max" ?>' method=post >
        <TABLE width="100%" align="center" cellspacing="0" cellpadding="0" >
          <tr> 
            <TD class="grisCCCCCC" height="58"> 
              <table BORDER=0  cellpad=2 cellspacing='2' WIDTH=100%  valign='top' align='center' cellpadding="2" >
                <tr bgcolor="titulos5"> 
          ...
          <tr> 
            <td class="grisCCCCCC"> 
              <table border=0 cellspacing='5' WIDTH=100%  align='center' class="table table-striped table-bordered table-hover dataTable no-footer smart-form" >
