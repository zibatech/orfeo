...
echo "Creando Folder .... ".$imap->addFolder("Orfeo_Mail_Procesados")."<<<";
$fechaHoy = date("Ymd");
$nombreCarpeta  = "Orfeo_Mail_Procesados"."/d_".$fechaHoy;

echo "Creando Folder .... ".$imap->addFolder($nombreCarpeta)."<<<";
$uid = $imap->getId (7933);
//$uid = 4055;
$mails = $imap->getMessages(10);
