...
$frad=date("Y-m-d h:i:s A");
	...
	,sgd_archivo_caja2) values ($sec,'$rad','$orden',to_date('$fechaIni','DD/MM/YYYY'),to_date('$fechaInif','DD/MM/YYYY'),'$ano','$depe','$demq','$demtq','$docu',$codiSRD,
	$codiSBRD,'$proc','$folios','$zon','$carro','$cara','$estante','$entre','$caja','$unidocu','$inder','$mata','$anexo','$presta','$funprest','$fprest','$fechaPrestf','$depeU','$krd',$dat,'$tip',to_date('$fechaa','DD/MM/YYYY'),'$numCap','$docu2','$dir','$caja2')";//TO_DATE('$frad','YYYY-MM-DD HH:MI:SS AM'))";
