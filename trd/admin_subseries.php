...
//--></script>
<form name="adm_subserie" id='adm_subserie' method='post'  action='admin_subseries.php?<?=session_name()."=".session_id()."&krd=$krd&tiem_ac=$tiem_ac&tiem_ag=$tiem_ag&fecha_busq=$fecha_busq&fecha_busq2=$fecha_busq2&codserie=$codserie&tsub=$tsub&detasub=$detasub&asu=$asu&id_serie=$id_serie"?>'>     
<br>
...
<TR>
 ...
 ?>
			<input name="idserie" type="text" size="20" class="tex_area" value="<?=$id_serie?>">
 </td>
 </td>
 <?
