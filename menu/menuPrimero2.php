...
?>
	<tr valign="middle">
		...
		<td width="125">
			<span class="Estilo12"><a href="envios/cuerpoMarcaEnviar.php?<?=$phpsession?>&krd=<?=$krd?>&<?php echo "fechaf=$fechah&usua_perm_impresion=$usua_perm_impresion&carpeta=8&nomcarpeta=Documentos Pendientes de Envio&orderTipo=desc&orderNo=3"; ?>" target='mainFrame' class="menu_princ">Envios</a></span>
		</td>
	</tr>
<?php
}
...
?>
	<tr>
		...
		<TD>
			<span class="Estilo12">
			<a href='devolucion/cuerpoDevCorreo.php?<?=$phpsession?>&<?php echo "fechaf=$fechah&carpeta=8&devolucion=2&estado_sal=4&nomcarpeta=Documentos Por Enviar&orno=1&adodb_next_page=1"; ?>' target='mainFrame' class="menu_princ" >Dev Correo</span></a>
		</td>
	</tr>
<?php
}
...
?>
	...
	<TD>
	<span class="Estilo12">
	<a href='devolucion/cuerpoDevCorreo.php?<?=$phpsession?>&<?php echo "fechaf=$fechah&carpeta=8&devolucion=2&estado_sal=4&nomcarpeta=Documentos Pendientes de Envio&orno=1&adodb_next_page=1"; ?>' target='mainFrame' class="menu_princ" >Dev Correo</span></a>
	</td>
	</tr>
				</table>
			</td>
