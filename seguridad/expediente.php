...
$responsableDoc = $expediente->getResponsable($num_expediente);
if( $responsableDoc == $usua_doc){
?>
<html>
<head>
...
<div class="alert alert-warning alert-dismissible" role="alert">
  ...
  <span class="glyphicon glyphicon-info-sign"></span> <strong>Upps !</strong> Usted no es responsable de este expediente y no puede modificar su seguridad.
</div>
</body>
<?php } ?>
