...
$infdel  = $tx->borrarInformado($radicados, $_SESSION["krd"], $depeCodiBorrar, $dependencia, $usuaCodiBorrar, $codusuario,  $observa);
...
if(!empty($infdel)){
    ...
    echo "<div class='alert alert-danger fade in'>
        ...
        <strong>Error al borrar los informados.$infdel</strong>
        Radicados $msginf
        </div>";
}
?>
