                      ...
                      <tr>
                          ...
                          <!--   <td class='listado2' height="25">
                           <a href='../devolucion/cuerpoDevOtras.php?<?=$datos_enviar?>&estado_sal=4&estado_sal_max=4&devolucion=1&krd=<?=$krd?>' class='vinculos'>
                              ...
                              <td class='listado2' height="25" colspan="2">
                            <a href='../devolucion/cuerpoDevGestion.php?<?=$datos_enviar?>&estado_sal=3&estado_sal_max=4&devolucion=1&krd=<?=$krd?>' class='vinculos'>
