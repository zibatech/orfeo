...
<body onLoad='document.getElementById("nurad").focus();'>
  <form id="form_buscar" action='NEW.php?<?=session_name()."=".session_id()."&krd=$krd"?>&Submit3=ModificarDocumentos'  name="FrmBuscar" class=celdaGris method="POST">
    <div class="col-sm-12">
      <!-- widget grid -->
      <h2></h2>
                    ...
                    <table class="table table-bordered table-striped">
                      <tr class='titulos2'>
                        ...
                        <td width="55%" class=listado2>
                          ...
                          <input id="boton_buscar" type=button name=Buscar1 Value="Buscar Radicado" class=botones_largo>
                        </td>
                      </tr>
                    </table>
                  </div>
