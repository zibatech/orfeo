...
<?php include ('header.php') ?>
	<div class="container">
		...
		<form action="pqrd_back.php" id="form-solicitud" enctype="multipart/form-data" method="post">
			<div class="row" id="formulario_afectado">
				<div class="col-sm">
						...
						<div class="col-md-6 form-group">
							<fieldset>
								...
								<div class="form-check form-check-inline">
									<input class="form-check-input" type="radio" name="afectado" id="afectado1" value="Si" data-required="true">
					...
					<div class="row">
						<div class="col-sm">
							<h4 class="text-success section-h">Información del paciente o afectado</h4>
						</div>
					</div>
					<div class="form-row">
						<div class="col-md-3 form-group">
							...
							<select name="tipo_identificacion_afectado" id="tipo_identificacion_afectado" title="Seleccionar" data-live-search="true" data-size="5" class="form-control" data-required="true">
						...
						<div class="col-md-3 form-group">
							...
							<input type="number" class="form-control" id="id_afectado" name="id_afectado" autocomplete="no" data-required="true">
						</div>
					</div>
					<div class="row">
						<div class="col-sm">
					...
					<div class="form-row">
						<div class="col-md-3 form-group">
							<label for="edad">* Edad <i class="bi bi-question-circle" data-toggle="tooltip" data-placement="top" title="Digite el número de años que tiene"></i></label>
							<input type="number" class="form-control" id="edad" name="edad" autocomplete="no" data-required="true">
						</div>
						<div class="col-md-3 form-group">
						...
						<div class="col-md-3 form-group">
							...
							<div class="form-check form-check-inline">
								<input class="form-check-input" type="radio" name="sexo" id="sexo1" value="Masculino" data-required="true">
					...
					<div class="form-row">
						<div class="col-md-6 form-group">
							...
							<select name="poblacion_especial" id="poblacion_especial" title="Seleccionar" data-live-search="true" data-size="5" class="form-control"  data-required="true">
						...
						<div class="col-md-6 form-group">
							...
							<select name="grupo_etnico" id="grupo_etnico" title="Seleccionar" data-live-search="true" data-size="5" class="form-control"  data-required="true">
					...
					<div class="form-row">
						...
						<div class="col-md-3 form-group">
							...
							<input type="text" class="form-control" id="direccion_afectado" name="direccion_afectado" autocomplete="no" data-required="true">
						</div>
					</div>
					<div class="row">
						<div class="col-sm">
					...
					<div class="form-row">
						<div class="col-md-3 form-group">
							...
							<div class="input-group mb-3">
								...
								<input type="number" class="form-control" id="celular_afectado" name="celular_afectado" autocomplete="no" data-required="true">
							</div>
						</div>
						<div class="col-md-3 form-group">
							...
							<div class="input-group mb-3">
								...
								<input type="number" class="form-control" id="telefono_afectado" name="telefono_afectado" autocomplete="no" data-required="true">
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-row">
								<div class="col-md-6 form-group">
									...
									<div class="input-group mb-3">
										...
										<input type="text" class="form-control" id="correo_afectado" name="correo_afectado" autocomplete="no" data-required="true">
									</div>
								</div>
								<div class="col-md-6 email-component">
									...
									<input type="text" class="form-control dominio" id="dominio_afectado" name="dominio_afectado" placeholder="dominio" aria-label="dominio" autocomplete="no" data-required="true">
								</div>
							</div>
						</div>
					</div>
			...
			<div class="form-row">
				<div class="col-md-6 form-group">
					...
					<select name="tipo_entidad" id="tipo_entidad" title="Seleccionar" data-live-search="true" data-size="5" class="form-control" data-required="true">
				...
				<div class="col-md-6 form-group">
					...
					<select name="entidad" id="entidad" title="Seleccionar" data-live-search="true" data-size="5" class="form-control" data-required="true"></select>
					<div id="entidad_bar" class="progress" style="display:none; height:5px;">
						<div class="progress-bar progress-bar-striped progress-bar-animated"  role="progressbar" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100" style="width: 100%"></div>
					</div>
				</div>
				<div class="col-md-6 form-group">
					<label for="ciudad_afiliacion">* Municipio de afiliación <i class="bi bi-question-circle" data-toggle="tooltip" data-placement="top" title="Seleccione la ciudad en la que el usuario se encuentra afiliado."></i></label>
					<select name="ciudad_afiliacion" id="ciudad_afiliacion" title="Seleccionar" data-live-search="true" data-size="5" class="form-control" data-required="true">
						<?php foreach ($municipios as $municipio) { ?>
							<option data-codi="<?=($municipio['DPTO_CODI'] * 1).($municipio['MUNI_CODI'] * 1)?>" value="<?=$municipio['DPTO_NOMB'].' / '.$municipio['MUNI_NOMB']?>"><?=$municipio['DPTO_NOMB'].' / '.$municipio['MUNI_NOMB']?></option>
						<?php } ?>
					</select>
					<small id="emailHelp" class="form-text text-muted">*ANM Areas no municipalizadas</small>
				</div>
				<!--
				<div class="col-md-6 form-group">
					<label for="ips_afiliacion">Seleccione la institución prestadora IPS <i class="bi bi-question-circle" data-toggle="tooltip" data-placement="top" title="Si desea informar adicionalmente la IPS, clínica u hospital que le prestó el servicio de salud sobre el que presenta inconformidad, seleccione"></i></label>
					<select name="ips_afiliacion" id="ips_afiliacion" title="Seleccionar" data-live-search="true" data-size="5" class="form-control">
					</select>
					<div id="ips_afiliacion_bar" class="progress" style="display:none; height:5px;">
						<div class="progress-bar progress-bar-striped progress-bar-animated"  role="progressbar" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100" style="width: 100%"></div>
					</div>
				</div>-->
			</div>
			...
			<div class="form-row">
				<div class="col-md-12 form-group limited-textarea">
					<label for="comentarios">* Escriba aquí lo que le está sucediendo: <i class="bi bi-question-circle" data-toggle="tooltip" data-placement="top" title="Digite la inconformidad o insatisfacción frente a la prestación del servicio de salud"></i></label>
			...
			<div class="row">
				<div class="col-md-12">
					<input id="agregar_archivo" type="button" class="btn btn-success" value="Adjuntar soportes">
				</div>
			</div>
			<div class="row">
				<div class="col-sm">
	...
	<script type="text/javascript">
		$(function()
		{
			...
			$('input[name="tipo"]').on('change', function(e) 
			{
				...
				switch(tipo){
					...
					case '2':
						...
						label_celular_peticionario = '* Teléfono fiscal <i class="bi bi-question-circle" data-toggle="tooltip" data-placement="top" title="Digite su número de teléfono fiscal, si no cuenta con esta información, seleccione la casilla de selección para deshabilitar el campo"></i>';
						label_telefono_peticionario = '* Teléfono comercial <i class="bi bi-question-circle" data-toggle="tooltip" data-placement="top" title="Digite su número de teléfono comercial, si no cuenta con esta información, seleccione la casilla de selección para deshabilitar el campo"></i>';
					break;
					case '3':
						$('div[data-natural]').hide();
						$('div[data-juridico]').hide();
			...
			$('#ciudad_afiliacion').on('change', function(e) {
				var option = $('#ciudad_afiliacion option:selected');
				$('#ips_afiliacion_bar').show();

				var request = $.post(
					'solicitudes_ajax.php',
					{
						servicio: 'ips',
						dpto_muni_codi: option.data('codi')
					},
					'json'
				);
				...
				request.done(function(res) {
					...
					if(res) {
						...
						$('#ips_afiliacion').html(options);
						$('#ips_afiliacion').selectpicker('refresh');
						$('#ips_afiliacion_bar').hide();
					}
				})
			});
			...
			*/
			...
			var file_template = `
				<div class="col-md-12" data-type="file_template" data-rel="" style="margin-top:10px; display:none;">
					<div class="form-row">
						<div class="col-md-3">
							<select class="ignore" name="tipo_documento[]" data-live-search="true" data-size="5" title="Seleccionar" data-required="true">
