...
<body aaonLoad="document.insExp.numeroExpediente.focus();">
<article class="col-sm-12" style="align:center">
<div class="content">
<div class="widget-body no-padding">
<form method="post" action="?nurad=<?=$nurad?>" name="insExpBus" class="smart-form">
      <!-- NEW WIDGET START -->
...
//echo $sql_Fin;
/*SGD_SEXP_FECH, SGD_SEXP_FECH,SGD_DIR_DOC,SGD_DIR_NOMREMDES, USUA_DOC_RESPONSABLE,SGD_SEXP_PAREXP1,  SGD_SEXP_PAREXP2,  SGD_SEXP_PAREXP3,  SGD_SEXP_PAREXP4,  SGD_SEXP_PAREXP5
...
*/
	...
	if($rs_Fin){
		...
		?>
			<small>
				Expedientes que coinciden con documento de remitente (Ultimos 10)
			</small>
		<?php
		}
		?>
			<div class="table-responsive">
				...
				<?  if(!$rs_Fin->EOF){ ?>
					...
					while(!$rs_Fin->EOF){
						...
						<td  align="left" width="10%"><small>
						<?
						echo $exp_P02; //$nom_Ent;
						?>
						</small></td>
						<td  align="left" width="5%"><small>
						<?
