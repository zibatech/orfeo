    ...
    {   //print_r($arrExpSeleccionados); 
        foreach( $arrExpSeleccionados as $clave => $numExpediente )
        {
            ...
            if( $resultadoExp == 1 )
            {
                ...
                print '<hr><font color=green> Se excluyó este radicado del expediente No. '.$numExpediente.'. correctamente. </font><hr>';
                print '<center><input name="cerrar" type="button" class="botones_funcion" id="envia22" onClick="opener.regresar(); window.close();" value=" Cerrar ">';
                exit;
            ...
            <div class="widget-body no-padding">
              ...
              <div class="table-responsive">
                <table class="table table-bordered table-striped">
                  ...
                  <?php //print_r($arrDatosExpediente);
